...
public class OrganizationServiceFacilityUpdateTest
{
    ...
    public void TestDeserialization()
    {
        var json = """
            ...
            """;
        var expectedObject = new OrganizationServiceFacilityUpdate
        {
            Name = "Test Service Facility",
        ...
        var deserializedObject = JsonUtils.Deserialize<OrganizationServiceFacilityUpdate>(json);
    ...
    public void TestSerialization()
    {
        var inputJson = """
            ...
            """;
        JsonAssert.Roundtrips<OrganizationServiceFacilityUpdate>(inputJson);
    }
}
