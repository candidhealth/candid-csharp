...
public class PatientHistoryCategoryTest
{
    ...
    public void TestDeserialization()
    {
        var json = """
            ...
            """;
        var expectedObject = new PatientHistoryCategory
        {
        ...
        var deserializedObject = JsonUtils.Deserialize<PatientHistoryCategory>(json);
    ...
    public void TestSerialization()
    {
        var inputJson = """
            ...
            """;
        JsonAssert.Roundtrips<PatientHistoryCategory>(inputJson);
    }
}
