...
public class OrganizationServiceFacilityTest
{
    ...
    public void TestDeserialization()
    {
        var json = """
            ...
            """;
        var expectedObject = new OrganizationServiceFacility
        {
        ...
        var deserializedObject = JsonUtils.Deserialize<OrganizationServiceFacility>(json);
    ...
    public void TestSerialization()
    {
        var inputJson = """
            ...
            """;
        JsonAssert.Roundtrips<OrganizationServiceFacility>(inputJson);
    }
}
