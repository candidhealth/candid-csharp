...
public class OrganizationProviderPageV2Test
{
    ...
    public void TestDeserialization()
    {
        var json = """
            ...
            """;
        var expectedObject = new OrganizationProviderPageV2
        {
            Items = new List<OrganizationProviderV2>()
            {
                new OrganizationProviderV2
                {
                    Npi = "1234567890",
                    IsRendering = true,
                    IsBilling = true,
        ...
        var deserializedObject = JsonUtils.Deserialize<OrganizationProviderPageV2>(json);
    ...
    public void TestSerialization()
    {
        var inputJson = """
            ...
            """;
        JsonAssert.Roundtrips<OrganizationProviderPageV2>(inputJson);
    }
}
