...
public class ExternalClaimSubmissionCreateOptionalTest
{
    ...
    public void TestDeserialization_1()
    {
        var json = """
            ...
            """;
        var expectedObject = new ExternalClaimSubmissionCreateOptional
        {
            ...
            SubmissionRecords = new List<ClaimSubmissionRecordCreateOptional>()
            {
                new ClaimSubmissionRecordCreateOptional
                {
        ...
        var deserializedObject = JsonUtils.Deserialize<ExternalClaimSubmissionCreateOptional>(json);
    ...
    public void TestSerialization_1()
    {
        var inputJson = """
            ...
            """;
        JsonAssert.Roundtrips<ExternalClaimSubmissionCreateOptional>(inputJson);
    }
