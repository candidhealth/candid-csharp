...
public class FindByMetadataTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/charge_captures/v1/find-by-metadata")
                    .UsingPost()
        ...
        var response = await Client.ChargeCapture.V1.FindByMetadataAsync(
