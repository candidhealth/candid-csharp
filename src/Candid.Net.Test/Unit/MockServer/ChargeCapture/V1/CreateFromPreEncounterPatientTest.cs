using global::Candid.Net.ChargeCapture.V1;
...
public class CreateFromPreEncounterPatientTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/charge_captures/v1/create-from-pre-encounter")
                    .UsingPost()
        ...
        var response = await Client.ChargeCapture.V1.CreateFromPreEncounterPatientAsync(
