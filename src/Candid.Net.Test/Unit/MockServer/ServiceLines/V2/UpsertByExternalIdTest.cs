...
public class UpsertByExternalIdTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/service-lines/v2/external-id/external_id")
                    .UsingPut()
        ...
        var response = await Client.ServiceLines.V2.UpsertByExternalIdAsync(
            "external_id",
