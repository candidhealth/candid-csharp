using global::Candid.Net.NonInsurancePayerRefunds.V1;
...
public class GetMultiTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/non-insurance-payer-refunds/v1")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.NonInsurancePayerRefunds.V1.GetMultiAsync(
