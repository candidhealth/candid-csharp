...
[TestFixture]
public class GetMultiPaginatedTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/coverages/v1/get-multi-paginated")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.PreEncounter.Coverages.V1.GetMultiPaginatedAsync(
