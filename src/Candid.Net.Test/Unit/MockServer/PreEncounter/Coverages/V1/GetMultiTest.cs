...
public class GetMultiTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(WireMock.RequestBuilders.Request.Create().WithPath("/coverages/v1").UsingGet())
            .RespondWith(
                WireMock
        ...
        var response = await Client.PreEncounter.Coverages.V1.GetMultiAsync(
            new CoverageGetMultiRequest()
        );
