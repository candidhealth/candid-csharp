...
public class GetAppointmentListTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        var response = await Client.PreEncounter.Lists.V1.GetAppointmentListAsync(
