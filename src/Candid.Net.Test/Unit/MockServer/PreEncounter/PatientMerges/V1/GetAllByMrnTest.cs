...
public class GetAllByMrnTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/patient-merge/v1/all/mrn")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.PreEncounter.PatientMerges.V1.GetAllByMrnAsync("mrn");
