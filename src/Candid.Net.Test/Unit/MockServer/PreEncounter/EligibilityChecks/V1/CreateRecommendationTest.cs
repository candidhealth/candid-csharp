...
public class CreateRecommendationTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/eligibility-checks/v1/recommendation")
                    .UsingPost()
        ...
        var response = await Client.PreEncounter.EligibilityChecks.V1.CreateRecommendationAsync(
