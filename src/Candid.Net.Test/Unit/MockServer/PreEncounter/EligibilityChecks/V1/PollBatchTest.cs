...
public class PollBatchTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/eligibility-checks/v1/batch/batch_id")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.PreEncounter.EligibilityChecks.V1.PollBatchAsync(
            "batch_id",
