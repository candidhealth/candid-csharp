...
public class EncounterEligibilityTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/eligibility-checks/v1/encounter_eligibility")
                    .WithParam("encounter_id", "encounter_id")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.PreEncounter.EligibilityChecks.V1.EncounterEligibilityAsync(
