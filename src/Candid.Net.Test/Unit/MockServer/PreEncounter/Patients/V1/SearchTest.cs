...
public class SearchTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(WireMock.RequestBuilders.Request.Create().WithPath("/patients/v1").UsingGet())
            .RespondWith(
                WireMock
        ...
        var response = await Client.PreEncounter.Patients.V1.SearchAsync(
            new PatientGetMultiRequest()
        );
