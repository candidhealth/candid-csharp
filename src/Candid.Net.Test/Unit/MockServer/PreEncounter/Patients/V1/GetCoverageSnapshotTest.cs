...
public class GetCoverageSnapshotTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/patients/v1/id/snapshot")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.PreEncounter.Patients.V1.GetCoverageSnapshotAsync(
            "id",
