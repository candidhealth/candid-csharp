using global::Candid.Net.ChargeCaptureBundles.V1;
...
public class GetAllTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/charge_capture_claim_creation/v1")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.ChargeCaptureBundles.V1.GetAllAsync(
