...
public class CreateOrderingProviderTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath(
                        "/api/encounter-providers/v2/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32/create-ordering-provider"
                    )
                    .UsingPost()
        ...
        var response = await Client.EncounterProviders.V2.CreateOrderingProviderAsync(
