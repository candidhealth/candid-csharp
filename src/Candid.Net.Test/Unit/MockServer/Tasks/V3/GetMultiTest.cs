using global::Candid.Net.Tasks.V3;
...
public class GetMultiTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(WireMock.RequestBuilders.Request.Create().WithPath("/api/tasks/v3").UsingGet())
            .RespondWith(
                WireMock
        ...
        var response = await Client.Tasks.V3.GetMultiAsync(new GetAllTasksRequest());
