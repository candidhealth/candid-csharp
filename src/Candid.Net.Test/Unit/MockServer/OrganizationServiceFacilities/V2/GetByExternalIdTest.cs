...
public class GetByExternalIdTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/organization-service-facilities/v2/external-id/external_id")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.OrganizationServiceFacilities.V2.GetByExternalIdAsync(
            "external_id"
        );
