...
[TestFixture]
public class CreateFromPreEncounterPatientUniversalTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/encounters/v4/create-from-pre-encounter/universal")
                    .UsingPost()
        ...
        var response = await Client.Encounters.V4.CreateFromPreEncounterPatientUniversalAsync(
