...
public class GetAllTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
              ...
              "items": [
                {
                  ...
                  "patient_payments": [
                    {
                      ...
                      "source": "MANUAL_ENTRY",
                      "amount_cents": 2000,
                      "payment_timestamp": "2023-01-01T00:00:00.000Z",
                      "status": "PENDING",
                  ...
                  "work_queue_id": "12",
                  "work_queue_membership_activated_at": "2023-01-01T00:00:00.000Z",
                  ...
                  "organization_id": "6df0c51d-2b4c-4af8-acc1-5c0b589e9b26"
                }
              ]
            }
            """;
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/encounters/v4")
                    .WithParam("limit", "100")
                    .WithParam("claim_status", "biller_received")
                    .WithParam("sort", "created_at:asc")
                    .WithParam("page_token", "eyJ0b2tlbiI6IjEiLCJwYWdlX3Rva2VuIjoiMiJ9")
                    .WithParam("date_of_service_min", "2019-08-24")
                    .WithParam("date_of_service_max", "2019-08-25")
                    .WithParam("primary_payer_names", "Medicare", "Medicaid")
                    .WithParam("search_term", "doe")
                    .WithParam("external_id", "123456")
                    .WithParam("diagnoses_updated_since", "2019-08-24T14:15:22.000Z")
                    .UsingGet()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.Encounters.V4.GetAllAsync(
            new GetAllEncountersRequest
            {
                ...
                SearchTerm = "doe",
                ExternalId = "123456",
                DiagnosesUpdatedSince = DateTime.Parse(
