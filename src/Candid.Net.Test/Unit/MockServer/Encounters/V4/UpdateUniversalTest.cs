...
public class UpdateUniversalTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/encounters/v4/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32/universal")
                    .UsingPatch()
        ...
        var response = await Client.Encounters.V4.UpdateUniversalAsync(
