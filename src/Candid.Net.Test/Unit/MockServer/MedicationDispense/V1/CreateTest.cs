...
using global::Candid.Net.MedicationDispense.V1;
using global::Candid.Net.Test.Unit.MockServer;
using global::Candid.Net.Test.Utils;
using NUnit.Framework;

namespace Candid.Net.Test.Unit.MockServer.MedicationDispense.V1;
...
public class CreateTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/medication-dispense/v1")
                    .UsingPost()
        ...
        var response = await Client.MedicationDispense.V1.CreateAsync(
