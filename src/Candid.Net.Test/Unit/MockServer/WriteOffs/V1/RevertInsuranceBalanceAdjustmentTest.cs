...
public class RevertInsuranceBalanceAdjustmentTest : BaseMockServerTest
{
    ...
    public async global::System.Threading.Tasks.Task MockServerTest()
    {
        ...
        Server
            .Given(
                WireMock
                    ...
                    .WithPath("/api/write-offs/v1/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32/revert")
                    .UsingPost()
            )
            .RespondWith(
                WireMock
        ...
        var response = await Client.WriteOffs.V1.RevertInsuranceBalanceAdjustmentAsync(
