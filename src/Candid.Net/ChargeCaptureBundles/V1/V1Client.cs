...
public partial class V1Client : IV1Client
{
    ...
    private async global::System.Threading.Tasks.Task<RawResponse> ResolveChargeCreationErrorAsyncCore(
    ...
    {
        var _queryString = new global::Candid.Net.Core.QueryStringBuilder.Builder(capacity: 25)
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask ResolveChargeCreationErrorAsync(
        string chargeCaptureBundleErrorId,
        ChargeCaptureBundleErrorResolution request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(
            ResolveChargeCreationErrorAsyncCore(
                chargeCaptureBundleErrorId,
                request,
                options,
                cancellationToken
            )
