...
public partial class V3Client : IV3Client
{
    ...
    {
        var _queryString = new global::Candid.Net.Core.QueryStringBuilder.Builder(capacity: 13)
    ...
    private async global::System.Threading.Tasks.Task<RawResponse> DeleteRateAsyncCore(
        string rateId,
        int version,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    ...
    /// </code></example>
    public WithRawResponseTask DeleteRateAsync(
        string rateId,
        int version,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(
            DeleteRateAsyncCore(rateId, version, options, cancellationToken)
        );
    }
