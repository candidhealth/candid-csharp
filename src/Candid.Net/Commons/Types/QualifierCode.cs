...
[JsonConverter(typeof(QualifierCode.QualifierCodeSerializer))]
[Serializable]
public readonly record struct QualifierCode : IStringEnum
{
    ...
    internal class QualifierCodeSerializer : JsonConverter<QualifierCode>
    {
        public override QualifierCode Read(
        ...
        )
        {
            ...
            return new QualifierCode(stringValue);
        }
        ...
        public override QualifierCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
