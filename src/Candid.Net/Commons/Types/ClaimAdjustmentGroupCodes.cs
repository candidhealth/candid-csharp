...
[JsonConverter(typeof(ClaimAdjustmentGroupCodes.ClaimAdjustmentGroupCodesSerializer))]
[Serializable]
public readonly record struct ClaimAdjustmentGroupCodes : IStringEnum
{
    ...
    internal class ClaimAdjustmentGroupCodesSerializer : JsonConverter<ClaimAdjustmentGroupCodes>
    {
        public override ClaimAdjustmentGroupCodes Read(
        ...
        )
        {
            ...
            return new ClaimAdjustmentGroupCodes(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ClaimAdjustmentGroupCodes value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ClaimAdjustmentGroupCodes ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
