...
[JsonConverter(typeof(FacilityTypeCode.FacilityTypeCodeSerializer))]
[Serializable]
public readonly record struct FacilityTypeCode : IStringEnum
{
    ...
    internal class FacilityTypeCodeSerializer : JsonConverter<FacilityTypeCode>
    {
        public override FacilityTypeCode Read(
        ...
        )
        {
            ...
            return new FacilityTypeCode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            FacilityTypeCode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override FacilityTypeCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
