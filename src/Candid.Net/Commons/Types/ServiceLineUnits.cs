...
[JsonConverter(typeof(ServiceLineUnits.ServiceLineUnitsSerializer))]
[Serializable]
public readonly record struct ServiceLineUnits : IStringEnum
{
    ...
    internal class ServiceLineUnitsSerializer : JsonConverter<ServiceLineUnits>
    {
        public override ServiceLineUnits Read(
        ...
        )
        {
            ...
            return new ServiceLineUnits(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ServiceLineUnits value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ServiceLineUnits ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
