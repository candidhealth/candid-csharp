...
public partial class V3Client : IV3Client
{
    ...
    private async global::System.Threading.Tasks.Task<WithRawResponse<TaskPage>> GetMultiAsyncCore(
        GetAllTasksRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        var _queryString = new global::Candid.Net.Core.QueryStringBuilder.Builder(capacity: 15)
            .Add("limit", request.Limit)
            .Add("page_token", request.PageToken)
            .Add("status", request.Status)
            .Add("statuses", request.Statuses)
            .Add("task_type", request.TaskType)
            .Add("task_types", request.TaskTypes)
    ...
    private async global::System.Threading.Tasks.Task<WithRawResponse<Task>> GetAsyncCore(
        string taskId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    ...
    private async global::System.Threading.Tasks.Task<WithRawResponse<Task>> CreateAsyncCore(
    ...
    private async global::System.Threading.Tasks.Task<WithRawResponse<Task>> UpdateAsyncCore(
        string taskId,
