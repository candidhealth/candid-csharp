...
[JsonConverter(typeof(TaskType.TaskTypeSerializer))]
[Serializable]
public readonly record struct TaskType : IStringEnum
{
    ...
    internal class TaskTypeSerializer : JsonConverter<TaskType>
    {
        public override TaskType Read(
        ...
        )
        {
            ...
            return new TaskType(stringValue);
        }
        ...
        public override TaskType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
