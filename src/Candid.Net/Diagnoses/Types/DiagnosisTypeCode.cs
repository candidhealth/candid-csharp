...
[JsonConverter(typeof(DiagnosisTypeCode.DiagnosisTypeCodeSerializer))]
[Serializable]
public readonly record struct DiagnosisTypeCode : IStringEnum
{
    ...
    internal class DiagnosisTypeCodeSerializer : JsonConverter<DiagnosisTypeCode>
    {
        public override DiagnosisTypeCode Read(
        ...
        )
        {
            ...
            return new DiagnosisTypeCode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            DiagnosisTypeCode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override DiagnosisTypeCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
