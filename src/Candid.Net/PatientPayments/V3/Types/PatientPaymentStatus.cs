...
[JsonConverter(typeof(PatientPaymentStatus.PatientPaymentStatusSerializer))]
[Serializable]
public readonly record struct PatientPaymentStatus : IStringEnum
{
    ...
    internal class PatientPaymentStatusSerializer : JsonConverter<PatientPaymentStatus>
    {
        public override PatientPaymentStatus Read(
        ...
        )
        {
            ...
            return new PatientPaymentStatus(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            PatientPaymentStatus value,
            JsonSerializerOptions options
        )
        {
        ...
        public override PatientPaymentStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
