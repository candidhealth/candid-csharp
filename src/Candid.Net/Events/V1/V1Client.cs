...
public partial class V1Client : IV1Client
{
    ...
    private async global::System.Threading.Tasks.Task<WithRawResponse<EventScanPage>> ScanAsyncCore(
    ...
    )
    {
        var _queryString = new Candid.Net.Core.QueryStringBuilder.Builder(capacity: 5)
            ...
            .Add("created_after", request.CreatedAfter)
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<EventScanPage>(responseBody)!;
                return new WithRawResponse<EventScanPage>()
                {
                    Data = responseData,
    ...
    private async global::System.Threading.Tasks.Task<WithRawResponse<Event>> GetAsyncCore(
        string eventId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<Event>(responseBody)!;
                return new WithRawResponse<Event>()
                {
                    Data = responseData,
                    RawResponse = new RawResponse()
                    {
    ...
    /// </code></example>
    public WithRawResponseTask<EventScanPage> ScanAsync(
        GetEventScanRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<EventScanPage>(
    ...
    /// </code></example>
    public WithRawResponseTask<Event> GetAsync(
        string eventId,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<Event>(GetAsyncCore(eventId, options, cancellationToken));
    }
}
