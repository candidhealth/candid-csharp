...
[Serializable]
public record ServiceLineCreateOptional : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public DrugIdentificationOptional? DrugIdentification { get; set; }
    ...
    public OrderingProviderOptional? OrderingProvider { get; set; }
    ...
    public IEnumerable<TestResultOptional>? TestResults { get; set; }
