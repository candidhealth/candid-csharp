...
[JsonConverter(typeof(TestResultType.TestResultTypeSerializer))]
[Serializable]
public readonly record struct TestResultType : IStringEnum
{
    ...
    internal class TestResultTypeSerializer : JsonConverter<TestResultType>
    {
        public override TestResultType Read(
        ...
        )
        {
            ...
            return new TestResultType(stringValue);
        }
        ...
        public override TestResultType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
