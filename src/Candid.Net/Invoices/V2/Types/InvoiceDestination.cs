...
[JsonConverter(typeof(InvoiceDestination.InvoiceDestinationSerializer))]
[Serializable]
public readonly record struct InvoiceDestination : IStringEnum
{
    ...
    public static readonly InvoiceDestination Revspring = new(Values.Revspring);
    ...
    internal class InvoiceDestinationSerializer : JsonConverter<InvoiceDestination>
    {
        public override InvoiceDestination Read(
        ...
        )
        {
            ...
            return new InvoiceDestination(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            InvoiceDestination value,
            JsonSerializerOptions options
        )
        {
        ...
        public override InvoiceDestination ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
    ...
    public static class Values
    {
        ...
        public const string Revspring = "REVSPRING";
    }
}
