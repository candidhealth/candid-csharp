...
[Serializable]
public record InstitutionalContract : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<ContractServiceFacility> ContractServiceFacilities { get; set; } =
        new List<ContractServiceFacility>();
