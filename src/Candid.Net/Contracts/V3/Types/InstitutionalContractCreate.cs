...
[Serializable]
public record InstitutionalContractCreate : IJsonOnDeserialized
{
    [JsonExtensionData]
    private readonly IDictionary<string, JsonElement> _extensionData =
        new Dictionary<string, JsonElement>();

    [JsonPropertyName("contract_service_facilities")]
    public IEnumerable<ContractServiceFacilityBase> ContractServiceFacilities { get; set; } =
        new List<ContractServiceFacilityBase>();
