...
[Serializable]
public record InstitutionalContractUpdate : IJsonOnDeserialized
{
    [JsonExtensionData]
    private readonly IDictionary<string, JsonElement> _extensionData =
        new Dictionary<string, JsonElement>();

    [JsonPropertyName("contract_service_facility_ids")]
    public HashSet<string>? ContractServiceFacilityIds { get; set; }
