...
public record ContractCreateUnion
{
    ...
    internal sealed class JsonConverter : JsonConverter<ContractCreateUnion>
    {
        ...
        )
        {
            ...
            {
                "professional" =>
                    jsonWithoutDiscriminator.Deserialize<global::Candid.Net.Contracts.V3.ProfessionalContractCreate?>(
                        options
                    )
                        ?? throw new JsonException(
                ...
                "institutional" =>
                    jsonWithoutDiscriminator.Deserialize<global::Candid.Net.Contracts.V3.InstitutionalContractCreate?>(
                        options
                    )
                        ?? throw new JsonException(
        ...
        public override ContractCreateUnion ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new ContractCreateUnion(stringValue, stringValue);
        }
