...
[JsonConverter(typeof(RegionsUpdate.JsonConverter))]
[Serializable]
public record RegionsUpdate
{
    internal RegionsUpdate(string type, object? value)
    {
        Type = type;
        Value = value;
    }
    ...
    /// <summary>
    /// Create an instance of RegionsUpdate with <see cref="RegionsUpdate.Set"/>.
    /// </summary>
    public RegionsUpdate(RegionsUpdate.Set value)
    {
        Type = "set";
        Value = value.Value;
    }
    ...
    /// <summary>
    /// Create an instance of RegionsUpdate with <see cref="RegionsUpdate.Remove"/>.
    /// </summary>
    public RegionsUpdate(RegionsUpdate.Remove value)
    {
        Type = "remove";
        Value = value.Value;
    }
    ...
    public static implicit operator RegionsUpdate(RegionsUpdate.Set value) => new(value);

    [Serializable]
    internal sealed class JsonConverter : JsonConverter<RegionsUpdate>
    {
        public override bool CanConvert(global::System.Type typeToConvert) =>
            typeof(RegionsUpdate).IsAssignableFrom(typeToConvert);

        public override RegionsUpdate Read(
