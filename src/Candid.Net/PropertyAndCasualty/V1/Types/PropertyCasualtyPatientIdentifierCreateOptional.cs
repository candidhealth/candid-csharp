...
[Serializable]
public record PropertyCasualtyPatientIdentifierCreateOptional : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public PropertyCasualtyPatientIdentifierQualifier? PropertyCasualtyPatientIdentifierQualifier { get; set; }
    ...
    public string? PropertyCasualtyPatientIdentifier { get; set; }
