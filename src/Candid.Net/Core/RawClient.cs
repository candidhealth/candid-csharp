...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal Task<global::Candid.Net.Core.ApiResponse> MakeRequestAsync(
        global::Candid.Net.Core.BaseRequest request,
    ...
    internal async Task<global::Candid.Net.Core.ApiResponse> SendRequestAsync(
        global::Candid.Net.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async Task<global::Candid.Net.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::Candid.Net.Core.ApiResponse
            {
    ...
    internal HttpRequestMessage CreateHttpRequest(global::Candid.Net.Core.BaseRequest request)
    {
    ...
    private static string BuildUrl(global::Candid.Net.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::Candid.Net.Core.ApiResponse instead.")]
    internal record ApiResponse : global::Candid.Net.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::Candid.Net.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::Candid.Net.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Candid.Net.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::Candid.Net.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Candid.Net.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::Candid.Net.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Candid.Net.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : global::Candid.Net.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::Candid.Net.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::Candid.Net.Core.StreamRequest;
}
