...
[JsonConverter(typeof(TypeOfAdmissionOrVisitCode.TypeOfAdmissionOrVisitCodeSerializer))]
[Serializable]
public readonly record struct TypeOfAdmissionOrVisitCode : IStringEnum
{
    ...
    internal class TypeOfAdmissionOrVisitCodeSerializer : JsonConverter<TypeOfAdmissionOrVisitCode>
    {
        public override TypeOfAdmissionOrVisitCode Read(
        ...
        )
        {
            ...
            return new TypeOfAdmissionOrVisitCode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            TypeOfAdmissionOrVisitCode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override TypeOfAdmissionOrVisitCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
