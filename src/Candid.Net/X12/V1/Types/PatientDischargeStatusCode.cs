...
[JsonConverter(typeof(PatientDischargeStatusCode.PatientDischargeStatusCodeSerializer))]
[Serializable]
public readonly record struct PatientDischargeStatusCode : IStringEnum
{
    ...
    internal class PatientDischargeStatusCodeSerializer : JsonConverter<PatientDischargeStatusCode>
    {
        public override PatientDischargeStatusCode Read(
        ...
        )
        {
            ...
            return new PatientDischargeStatusCode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            PatientDischargeStatusCode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override PatientDischargeStatusCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
