...
[JsonConverter(typeof(Rarc.RarcSerializer))]
[Serializable]
public readonly record struct Rarc : IStringEnum
{
    ...
    internal class RarcSerializer : JsonConverter<Rarc>
    {
        public override Rarc Read(
        ...
        )
        {
            ...
            return new Rarc(stringValue);
        }

        public override void Write(Utf8JsonWriter writer, Rarc value, JsonSerializerOptions options)
        {
            writer.WriteStringValue(value.Value);
        }

        public override Rarc ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
