...
[JsonConverter(typeof(TypeOfFacilityCode.TypeOfFacilityCodeSerializer))]
[Serializable]
public readonly record struct TypeOfFacilityCode : IStringEnum
{
    ...
    internal class TypeOfFacilityCodeSerializer : JsonConverter<TypeOfFacilityCode>
    {
        public override TypeOfFacilityCode Read(
        ...
        )
        {
            ...
            return new TypeOfFacilityCode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            TypeOfFacilityCode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override TypeOfFacilityCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
