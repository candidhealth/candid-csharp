...
[JsonConverter(typeof(TypeOfCareCode.TypeOfCareCodeSerializer))]
[Serializable]
public readonly record struct TypeOfCareCode : IStringEnum
{
    ...
    internal class TypeOfCareCodeSerializer : JsonConverter<TypeOfCareCode>
    {
        public override TypeOfCareCode Read(
        ...
        )
        {
            ...
            return new TypeOfCareCode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            TypeOfCareCode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override TypeOfCareCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
