...
[JsonConverter(typeof(TypeOfBillFrequencyCode.TypeOfBillFrequencyCodeSerializer))]
[Serializable]
public readonly record struct TypeOfBillFrequencyCode : IStringEnum
{
    ...
    internal class TypeOfBillFrequencyCodeSerializer : JsonConverter<TypeOfBillFrequencyCode>
    {
        public override TypeOfBillFrequencyCode Read(
        ...
        )
        {
            ...
            return new TypeOfBillFrequencyCode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            TypeOfBillFrequencyCode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override TypeOfBillFrequencyCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
