...
public record OrganizationProviderV2
{
    /// <summary>
    ...
    public required bool IsRendering { get; init; }

    /// <summary>
    /// Whether the provider can be used to bill services.
    /// </summary>
    [JsonPropertyName("is_billing")]
    public required bool IsBilling { get; init; }
    ...
    public DateOnly? EmploymentTerminationDate { get; init; }
    ...
    public IEnumerable<Identifier> Qualifications { get; init; } = new List<Identifier>();
}
