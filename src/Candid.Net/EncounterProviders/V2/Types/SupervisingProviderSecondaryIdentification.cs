...
[Serializable]
public record SupervisingProviderSecondaryIdentification : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public required ProviderSecondaryIdentificationQualifier ReferenceIdentificationQualifier { get; set; }
