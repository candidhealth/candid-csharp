...
/// </summary>
[Serializable]
public record BillingProviderUpdateWithOptionalAddress : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public BillingProviderSecondaryIdentificationOptional? SecondaryIdentification { get; set; }
