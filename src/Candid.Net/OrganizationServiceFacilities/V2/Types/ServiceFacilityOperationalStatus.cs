...
[JsonConverter(typeof(ServiceFacilityOperationalStatus.ServiceFacilityOperationalStatusSerializer))]
[Serializable]
public readonly record struct ServiceFacilityOperationalStatus : IStringEnum
{
    ...
    internal class ServiceFacilityOperationalStatusSerializer
        : JsonConverter<ServiceFacilityOperationalStatus>
    {
        public override ServiceFacilityOperationalStatus Read(
        ...
        )
        {
            ...
            return new ServiceFacilityOperationalStatus(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ServiceFacilityOperationalStatus value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ServiceFacilityOperationalStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
