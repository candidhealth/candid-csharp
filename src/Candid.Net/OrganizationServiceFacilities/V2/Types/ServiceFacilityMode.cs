...
[JsonConverter(typeof(ServiceFacilityMode.ServiceFacilityModeSerializer))]
[Serializable]
public readonly record struct ServiceFacilityMode : IStringEnum
{
    ...
    internal class ServiceFacilityModeSerializer : JsonConverter<ServiceFacilityMode>
    {
        public override ServiceFacilityMode Read(
        ...
        )
        {
            ...
            return new ServiceFacilityMode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            ServiceFacilityMode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override ServiceFacilityMode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
