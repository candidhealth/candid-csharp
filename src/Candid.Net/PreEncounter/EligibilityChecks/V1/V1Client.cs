...
public partial class V1Client : IV1Client
{
    ...
    private async global::System.Threading.Tasks.Task<
        WithRawResponse<InsuranceDiscoveryResponse>
    > InsuranceDiscoveryAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<InsuranceDiscoveryResponse>(responseBody)!;
                return new WithRawResponse<InsuranceDiscoveryResponse>()
                {
                    Data = responseData,
                    RawResponse = new global::Candid.Net.RawResponse()
                    {
    ...
    private async global::System.Threading.Tasks.Task<
        WithRawResponse<CoordinationOfBenefitsResponse>
    > CoordinationOfBenefitsAsyncCore(
    ...
    )
    {
        ...
        if (response.StatusCode is >= 200 and < 400)
        {
            ...
            try
            {
                var responseData = JsonUtils.Deserialize<CoordinationOfBenefitsResponse>(
                    responseBody
                )!;
                return new WithRawResponse<CoordinationOfBenefitsResponse>()
                {
                    Data = responseData,
                    RawResponse = new global::Candid.Net.RawResponse()
                    {
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<InsuranceDiscoveryResponse> InsuranceDiscoveryAsync(
        InsuranceDiscoveryRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask<InsuranceDiscoveryResponse>(
            InsuranceDiscoveryAsyncCore(request, options, cancellationToken)
        );
    }
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask<CoordinationOfBenefitsResponse> CoordinationOfBenefitsAsync(
        CoordinationOfBenefitsRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
