...
[JsonConverter(typeof(Ethnicity.EthnicitySerializer))]
[Serializable]
public readonly record struct Ethnicity : IStringEnum
{
    ...
    internal class EthnicitySerializer : JsonConverter<Ethnicity>
    {
        public override Ethnicity Read(
        ...
        )
        {
            ...
            return new Ethnicity(stringValue);
        }
        ...
        public override Ethnicity ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
