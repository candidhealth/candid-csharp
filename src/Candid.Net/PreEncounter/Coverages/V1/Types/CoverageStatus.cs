...
[JsonConverter(typeof(CoverageStatus.CoverageStatusSerializer))]
[Serializable]
public readonly record struct CoverageStatus : IStringEnum
{
    ...
    internal class CoverageStatusSerializer : JsonConverter<CoverageStatus>
    {
        public override CoverageStatus Read(
        ...
        )
        {
            ...
            return new CoverageStatus(stringValue);
        }
        ...
        public override CoverageStatus ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
