...
public partial class V1Client : IV1Client
{
    ...
    {
        var _queryString = new global::Candid.Net.Core.QueryStringBuilder.Builder(capacity: 4)
    ...
    private async global::System.Threading.Tasks.Task<RawResponse> BatchUpdatePpgAsyncCore(
        string ppgId,
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask BatchUpdatePpgAsync(
        string ppgId,
        PayerPlanGroupFields request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(
            BatchUpdatePpgAsyncCore(ppgId, request, options, cancellationToken)
        );
    }
