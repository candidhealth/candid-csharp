...
/// </summary>
[Serializable]
public record AppointmentReasonDetail : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public IEnumerable<string>? DiagnosisCodes { get; set; }

    [JsonPropertyName("procedure_codes")]
    public IEnumerable<string>? ProcedureCodes { get; set; }
