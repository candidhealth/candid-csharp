...
public record BillingNoteMetadata
{
    ...
    internal sealed class JsonConverter : JsonConverter<BillingNoteMetadata>
    {
        ...
        )
        {
            ...
            {
                "queue_added" =>
                    jsonWithoutDiscriminator.Deserialize<global::Candid.Net.BillingNotes.V2.QueueAddedMetadata?>(
                        options
                    )
                        ?? throw new JsonException(
                ...
                "queue_moved" =>
                    jsonWithoutDiscriminator.Deserialize<global::Candid.Net.BillingNotes.V2.QueueMovedMetadata?>(
                        options
                    )
                        ?? throw new JsonException(
                ...
                "task_created" =>
                    jsonWithoutDiscriminator.Deserialize<global::Candid.Net.BillingNotes.V2.TaskCreatedMetadata?>(
                        options
                    )
                        ?? throw new JsonException(
        ...
        public override BillingNoteMetadata ReadAsPropertyName(
            ref Utf8JsonReader reader,
            global::System.Type typeToConvert,
            JsonSerializerOptions options
        )
        {
            ...
            return new BillingNoteMetadata(stringValue, stringValue);
        }
