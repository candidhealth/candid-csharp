...
[JsonConverter(typeof(OccurrenceSpanCode.OccurrenceSpanCodeSerializer))]
[Serializable]
public readonly record struct OccurrenceSpanCode : IStringEnum
{
    ...
    internal class OccurrenceSpanCodeSerializer : JsonConverter<OccurrenceSpanCode>
    {
        public override OccurrenceSpanCode Read(
        ...
        )
        {
            ...
            return new OccurrenceSpanCode(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            OccurrenceSpanCode value,
            JsonSerializerOptions options
        )
        {
        ...
        public override OccurrenceSpanCode ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
