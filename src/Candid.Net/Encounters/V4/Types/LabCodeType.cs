...
[JsonConverter(typeof(LabCodeType.LabCodeTypeSerializer))]
[Serializable]
public readonly record struct LabCodeType : IStringEnum
{
    ...
    internal class LabCodeTypeSerializer : JsonConverter<LabCodeType>
    {
        public override LabCodeType Read(
        ...
        )
        {
            ...
            return new LabCodeType(stringValue);
        }
        ...
        public override LabCodeType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
