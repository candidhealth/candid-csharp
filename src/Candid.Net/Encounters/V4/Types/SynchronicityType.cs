...
[JsonConverter(typeof(SynchronicityType.SynchronicityTypeSerializer))]
[Serializable]
public readonly record struct SynchronicityType : IStringEnum
{
    ...
    internal class SynchronicityTypeSerializer : JsonConverter<SynchronicityType>
    {
        public override SynchronicityType Read(
        ...
        )
        {
            ...
            return new SynchronicityType(stringValue);
        }

        public override void Write(
            Utf8JsonWriter writer,
            SynchronicityType value,
            JsonSerializerOptions options
        )
        {
        ...
        public override SynchronicityType ReadAsPropertyName(
            ref Utf8JsonReader reader,
            Type typeToConvert,
            JsonSerializerOptions options
        )
