...
public partial class V1Client : IV1Client
{
    ...
    private async global::System.Threading.Tasks.Task<RawResponse> DeleteByChargeCaptureExternalIdAsyncCore(
        string chargeCaptureExternalId,
    ...
    /// );
    /// </code></example>
    public WithRawResponseTask DeleteByChargeCaptureExternalIdAsync(
        string chargeCaptureExternalId,
        DeleteExternalAttachmentRequest request,
        RequestOptions? options = null,
        CancellationToken cancellationToken = default
    )
    {
        return new WithRawResponseTask(
            DeleteByChargeCaptureExternalIdAsyncCore(
                chargeCaptureExternalId,
                request,
                options,
                cancellationToken
    ...
    {
        return new WithRawResponseTask(
            DeleteAsyncCore(encounterId, request, options, cancellationToken)
        );
    }
}
